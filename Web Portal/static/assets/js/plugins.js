((e, t) => {
  ...
  try {
    A.apply((t = a.call(r.childNodes)), r.childNodes),
    ...
    if (!i && (Pe(e), (e = e || C), E)) {
      ...
      if (!(fe[t + " "] || (h && h.test(t)))) {
        if (((c = t), (u = e), 1 === d && (be.test(t) || ye.test(t)))) {
          for (
            ((u = (Ee.test(t) && Ne(e.parentNode)) || e) == e && g.scope) ||
              ((s = e.getAttribute("id"))
  ...
  function De() {
    ...
    function i(e, t) {
      return (
        n.push(e + " ") > k.cacheLength && delete i[n.shift()], (i[e + " "] = t)
      );
    }
    return i;
  }
          ...
          return e === t
            ...
            : (n = !e.compareDocumentPosition - !t.compareDocumentPosition) ||
                ...
                (!g.sortDetached && t.compareDocumentPosition(e) === n)
                  ? e === C || (e.ownerDocument == r && O.contains(r, e))
                    ? -1
                    : t === C || (t.ownerDocument == r && O.contains(r, t))
                    ? 1
                    : oe
  ...
  function We(m, v) {
    function e(e, t, n, i, r) {
      ...
      for (r && (re = t == C || t || r); c !== g && null != (o = f[c]); c++) {
        if (b && o) {
          for (
            s = 0, t || o.ownerDocument == C || (Pe(o), (n = !E));
            (a = m[s++]);
      ...
      if (((l += c), y && c !== l)) {
        ...
        if (e) {
          if (0 < l) for (; c--; ) u[c] || d[c] || (d[c] = K.call(i));
          d = Re(d);
        }
        A.apply(i, d),
  ...
  function $e(e, t, n, i) {
    ...
    if (((n = n || []), 1 === u.length)) {
      if (
        ...
        if (!(t = (k.find.ID(s.matches[0].replace(d, f), t) || [])[0]))
          return n;
      ...
      for (
        ...
        if (
          (l = k.find[a]) &&
          (i = l(
            s.matches[0].replace(d, f),
            (Ee.test(o[0].type) && Ne(t.parentNode)) || t
          ))
        ) {
    ...
    return (
      (c || ze(e, u))(i, t, !E, n, !t || (Ee.test(e) && Ne(t.parentNode)) || t),
      n
    );
  }
  (Ie.prototype = k.filters = k.pseudos),
    (k.setFilters = new Ie()),
    (g.sortStable = S.split("").sort(pe).join("") === S),
    Pe(),
    (g.sortDetached = Oe(function (e) {
  ...
  function Dt(e, t, n, i, r) {
    ...
    for (u.textContent = "", h = 0; (o = d[h++]); )
      if (i && -1 < T.inArray(o, i)) r && r.push(o);
        ...
        ((l = bt(o)), (s = m(u.appendChild(o), "script")), l && At(s), n)
      )
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          e = this || e;
          return (
            kt.test(e.type) && e.click && _(e, "input") && Pt(e, "click", !0),
            !1
          );
        },
        trigger: function (e) {
  ...
  function Wt(n, i, r, o) {
    ...
    var e,
      ...
      f = i[0],
      p = y(f);
    if (p || (1 < d && "string" == typeof f && !g.checkClone && Mt.test(f)))
    ...
    if (
      d &&
      ((t = (e = Dt(i, n[0].ownerDocument, !1, n, o)).firstChild),
  ...
  function zt(e, t, n) {
    for (var i, r = t ? T.filter(t, e) : e, o = 0; null != (i = r[o]); o++)
      n || 1 !== i.nodeType || T.cleanData(m(i)),
        i.parentNode &&
          (n && bt(i) && At(m(i, "script")), i.parentNode.removeChild(i));
    return e;
  }
  T.extend({
      ...
      if (
        ...
        for (s = m(u), i = 0, r = (o = m(e)).length; i < r; i++)
          (a = o[i]),
            (l = s[i]),
            (c = void 0),
            "input" === (c = l.nodeName.toLowerCase()) && kt.test(a.type)
              ? (l.checked = a.checked)
              : ("input" !== c && "textarea" !== c) ||
        ...
        if ((l = !T.isEmptyObject(t)) || !T.isEmptyObject(h))
          ...
          h))
            l ||
              ...
              p && Tt([e], !0),
              d.done(function () {
                for (i in (p || Tt([e]), v.remove(e, "fxshow"), h))
                  T.style(e, i, h[i]);
              })),
              (l = kn(p ? g[i] : 0, i, d)),
              i in g ||
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : An.test(e.nodeName) || (Sn.test(e.nodeName) && e.href)
              ? 0
              : -1;
          },
        },
    ...
    T.fn.extend({
      addClass: function (t) {
        ...
        return y(t)
          ...
          ? this.each(function () {
              if (
                ((i = On(this)), (n = 1 === this.nodeType && " " + Dn(i) + " "))
              ) {
          ...
          : ((e = Ln(t)),
            this.each(function () {
              if (a)
                ...
                (void 0 !== t && "boolean" != s) ||
                  ((i = On(this)) && v.set(this, "__className__", i),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
      ...
      hasClass: function (e) {
        for (var t, n = 0, i = " " + e + " "; (t = this[n++]); )
          if (1 === t.nodeType && -1 < (" " + Dn(On(t)) + " ").indexOf(i))
            return !0;
        return !1;
      },
    });
      ...
      (T.extend(T.event, {
        trigger: function (e, t, n, i) {
          ...
          if (
            3 !== n.nodeType &&
            8 !== n.nodeType &&
            !Hn.test(h + T.event.triggered) &&
            (-1 < h.indexOf(".") &&
              ((h = (f = h.split(".")).shift()), f.sort()),
            (a = h.indexOf(":") < 0 && "on" + h),
            ((e = e[T.expando]
              ? e
              : new T.Event(h, "object" == typeof e && e)).isTrigger = i
              ? 2
              : 3),
            (e.namespace = f.join(".")),
            ...
            if (!i && !c.noBubble && !H(n)) {
              for (
                s = c.delegateType || h, Hn.test(s + h) || (p = p.parentNode);
                p;
                p = p.parentNode
              )
                d.push(p), (o = p);
            ...
            return (
              ...
              i ||
                ...
                (a &&
                  ...
                  ((o = n[a]) && (n[a] = null),
                  (T.event.triggered = h),
                  e.isPropagationStopped() && u.addEventListener(h, jn),
                  n[h](),
                  e.isPropagationStopped() && u.removeEventListener(h, jn),
          ...
          _.setRequestHeader(
            ...
            p.dataTypes[0] && p.accepts[p.dataTypes[0]]
              ? p.accepts[p.dataTypes[0]] +
                  ("*" !== p.dataTypes[0] ? ", " + Gn + "; q=0.01" : "")
              : p.accepts["*"]
          ),
          p.headers))
            _.setRequestHeader(i, p.headers[i]);
          if (p.beforeSend && (!1 === p.beforeSend.call(g, _, p) || h))
            return _.abort();
          if (
            ((s = "abort"),
            y.add(p.complete),
            ...
            if (((_.readyState = 1), f && m.trigger("ajaxSend", [_, p]), h))
              return _;
            p.async &&
              0 < p.timeout &&
  ...
  ((e, t) => {
      ...
      (e = () => {
        ...
        if (n) {
          ...
          (n.fn[e] = i.jQueryInterface),
            ...
            (n.fn[e].noConflict = () => ((n.fn[e] = t), i.jQueryInterface));
        }
      }),
          ...
          if (d)
            for (var h of Object.keys(c)) {
              ...
              var f,
                ...
                y = t.slice(1),
                b = m[v] || {};
              for ([f, p] of Object.entries(b))
                f.includes(y) && se(g, m, v, p.callable, p.delegationSelector);
            }
    ...
    let u = {
      ...
      getDataAttributes(t) {
        ...
        var n,
          i = {};
        for (n of Object.keys(t.dataset).filter(
    ...
    let Te = "carousel",
      ...
      Ee = ".carousel-item";
    Ce, Ee;
    let Ae = { ArrowLeft: we, ArrowRight: p },
      Se = {
        interval: 5e3,
        keyboard: !0,
        pause: "hover",
    ...
    class Oe extends t {
      ...
      _addTouchEventListeners() {
        for (var e of d.find(".carousel-item img", this._element))
          g.on(e, "dragstart.bs.carousel", (e) => e.preventDefault());
        var t = {
    ...
    g.on(
      ...
      g.on(window, "load.bs.carousel.data-api", () => {
        var e;
        for (e of d.find('[data-bs-ride="carousel"]'))
    ...
    g.on(document, "click.bs.collapse.data-api", Ne, function (e) {
      ("A" === e.target.tagName ||
        ...
        e.preventDefault();
      for (var t of d.getMultipleElementsFromSelector(this))
    ...
    function vt(e) {
      var t,
        ...
        h = s.y,
        h = void 0 === h ? 0 : h,
        f = "function" == typeof u ? u({ x: d, y: h }) : { x: d, y: h },
    ...
    var yt = {
        ...
        fn: function (e) {
          var t = e.state,
            n = void 0 === (n = (e = e.options).gpuAcceleration) || n,
    ...
    var qt = {
      ...
      fn: function (e) {
        var s = e.state,
          t = e.name,
          a = void 0 === (e = e.options.offset) ? [0, 0] : e,
                ...
                (t =
                  (n =
                    "function" == typeof i
                      ...
                      : i)[0] || 0),
                (i = (n[1] || 0) * o),
                0 <= [O, D].indexOf(r) ? { x: i, y: t } : { x: t, y: i })),
              e
            );
          }, {}),
          n = (i = e[s.placement]).x,
    ...
    var Rt = {
      ...
      fn: function (e) {
        var t,
          ...
          p = void 0 === (p = d.tether) || p,
          g = void 0 === (g = d.tetherOffset) ? 0 : g,
          d = Nt(u, {
            boundary: d.boundary,
          ...
          g =
            ...
            typeof (g =
              "function" == typeof g
                ? g(Object.assign({}, u.rects, { placement: u.placement }))
                : g)
        ...
        w &&
          (h &&
            ...
            (c = ut(0, x[h], o[h])),
            (o = y
              ? x[h] / 2 - t - c - n - g.mainAxis
              : r - c - n - g.mainAxis),
            (r = y
              ? -x[h] / 2 + t + c + i + g.mainAxis
              : v + c + i + g.mainAxis),
            (y = (n = u.elements.arrow && lt(u.elements.arrow))
              ? "y" === b
                ? n.clientTop || 0
                : n.clientLeft || 0
              : 0),
            (v = a + r - (t = null != (h = null == k ? void 0 : k[b]) ? h : 0)),
            (c = ut(p ? Ze(s, a + o - t - y) : s, a, p ? E(l, v) : l)),
            (w[b] = c),
            (C[b] = c - a)),
          f &&
            ((i = "y" == _ ? "height" : "width"),
            ...
            (h = n - d["x" === b ? S : D]),
            (o = -1 !== [A, O].indexOf(m)),
            (y = null != (t = null == k ? void 0 : k[_]) ? t : 0),
            (s = o ? r : n - x[i] - T[i] - y + g.altAxis),
            (v = o ? n + x[i] + T[i] - y - g.altAxis : h),
            (a =
              p && o
          ...
          c = {
            ...
            setOptions: function (e) {
              var n,
                ...
                e =
                  (u(),
                  (s.options = Object.assign({}, h, s.options, e)),
                  (s.scrollParents = {
                    reference: y(i)
                      ? St(i)
                      : i.contextElement
    ...
    class k extends t {
      constructor(e, t) {
        super(e, t),
          ...
          (this._menu =
            d.next(this._element, Kt)[0] ||
            d.prev(this._element, Kt)[0] ||
            d.findOne(Kt, this._parent)),
        ...
        if (!a(this._element) && !this._isShown()) {
          ...
          if (!t.defaultPrevented) {
            if (
              ...
              for (var n of [].concat(...document.body.children))
                g.on(n, "mouseover", W);
            this._element.focus(),
        ...
        if (2 !== e.button && ("keyup" !== e.type || "Tab" === e.key))
          for (t of d.find(
            ...
            r &&
              ...
              ((n = (i = e.composedPath()).includes(r._menu)),
      ...
      static dataApiKeydownHandler(e) {
        ...
        (!i && !n) ||
          ...
          (n = k.getOrCreateInstance(t)),
          i
            ? (e.stopPropagation(), n.show(), n._selectMenuItem(e))
            : n._isShown() && (e.stopPropagation(), n.hide(), t.focus()));
      }
    }
    g.on(document, pt, T, k.dataApiKeydownHandler),
      g.on(document, pt, Kt, k.dataApiKeydownHandler),
      g.on(document, Qe, k.clearMenus),
      g.on(document, "keyup.bs.dropdown.data-api", k.clearMenus),
    ...
    class wn {
      ...
      _applyManipulationCallback(e, t) {
        if (o(e)) t(e);
        else for (var n of d.find(e, this._element)) t(n);
      }
    }
    let C = ".bs.modal";
    C, C;
    ...
    let kn = "modal-open",
      Cn = "modal-static";
    let En = { backdrop: !0, focus: !0, keyboard: !0 },
      An = {
    ...
    let Dn = "showing",
      ...
      Ln = "hidePrevented" + Xe,
      jn = "hidden" + Xe;
    let Nn = { backdrop: !0, keyboard: !0, scroll: !1 },
      Pn = {
        backdrop: "(boolean|string)",
        keyboard: "boolean",
        scroll: "boolean",
    ...
    g.on(
      ...
      function (e) {
        ...
        ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
          a(this) ||
            ...
            (e = d.findOne(On)) && e !== t && P.getInstance(e).hide(),
      ...
      g.on(window, "resize.bs.offcanvas", () => {
        for (var e of d.find("[aria-modal][class*=show][class*=offcanvas-]"))
    ...
    class Kn extends t {
      ...
      hide() {
        if (this._isShown()) {
          ...
          if (!e.defaultPrevented) {
            if (
              (this._getTipElement().classList.remove($n),
              "ontouchstart" in document.documentElement)
            )
      ...
      _createTipElement(e) {
        ...
        return (
          e.setAttribute("id", t), this._isAnimated() && e.classList.add(zn), e
        );
      }
      setContent(e) {
        (this._newContent = e),
      ...
      _setListeners() {
        var e, t, n;
        for (e of this._config.trigger.split(" "))
          "click" === e
            ? g.on(
                this._element,
      ...
      _getConfig(e) {
        var t,
          n = u.getDataAttributes(this._element);
        for (t of Object.keys(n)) Wn.has(t) && delete n[t];
        return (
          (e = { ...n, ...("object" == typeof e && e ? e : {}) }),
          (e = this._mergeConfigObj(e)),
          (e = this._configAfterMerge(e)),
          this._typeCheckConfig(e),
          e
    ...
    class si extends t {
      ...
      _initializeTargetsAndObservables() {
        ...
        for (e of d.find(ii, this._config.target))
          e.hash &&
            !a(e) &&
            ((t = d.findOne(decodeURI(e.hash), this._element)), s(t)) &&
